...
- [x] **Task 0.1 — Remove `syncAll` Polling**
...
- [x] **Task 0.2 — Remove Static Token Initialization**
  - **File**: `src/app/services/SyncService.ts`
...
- [x] **Task 0.3 — Refactor Sparse DynamoDB Updates**
...
- [x] **Task 0.4 — Remove Unsafe WebSocket Connections**
...
- [x] **Task 1.1 — Auto-Generate `.env` After Deploy**
...
- [x] **Task 1.2 — Fix CORS & Upsert in Sync Lambda**
  - **File**: `backend/sync/index.mjs`
...
- [x] **Task 1.3 — Add Pull & Delete Endpoints**
  - **File**: `backend/sync/index.mjs`
...
- [x] **Task 1.4 — Fix WebSocket Reverse Lookup**
  - **File**: `backend/websocket/index.mjs`
...
- [x] **Task 1.5 — Handle Stale WebSocket Connections**
...
- [x] **Task 2.1 — Wire Auth to App State**
...
- [x] **Task 2.4 — JWT Token Refresh in SyncService**
  - **File**: `src/app/services/SyncService.ts`
...
- [x] **Task 3.1 — Implement Dexie CDC (Change Data Capture)**
...
- [x] **Task 3.2 — Implement Pull Sync (Cloud → Local)**
  - **File**: `src/app/services/SyncService.ts`
...
- [x] **Task 4.1 — Extend Dexie Schema for Folders**
  - **File**: `src/app/db.ts`
  - Add a `Folder` interface + `parentId` to `Note`. Bump to `db.version(2)`.

- [x] **Task 4.2 — Build Recursive FileTree Component**
...
- [x] **Task 4.3 — Folder CRUD + Replace Sidebar List**
...
- [x] **Task 4.4 — Sync Folders to Backend**
  - **File**: `SyncService.ts`
...
- [x] **Task 5.1 — Create Presigned URL Endpoint**
  - **File**: `backend/sync/index.mjs`
  - Add a `POST /upload-url` handler that returns an S3 presigned PUT URL.

- [x] **Task 5.2 — Create Frontend Upload Service**
...
- [x] **Task 5.3 — Hook Editor.md Image Upload**
...
- [x] **Task 6.1 — Add Version Tracking**
...
- [x] **Task 6.2 — Handle Conflicts in SyncService**
